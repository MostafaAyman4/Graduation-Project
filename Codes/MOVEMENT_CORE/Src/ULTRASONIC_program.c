...
void HUltrasonic_voidInitX4(uint8 Copy_uint8TIMERNO){
	...
	case ULTRA_2_X4_TIMER_NO_COPY:
				...
				MDIO_voidSetDirection(ULTRA4_PORT_NO ,ULTRA5_ECHO_PIN ,INPUT_FLOATING);
				MDIO_voidSetDirection(ULTRA5_PORT_NO ,ULTRA6_ECHO_PIN ,INPUT_FLOATING);
				MDIO_voidSetDirection(ULTRA6_PORT_NO ,ULTRA7_ECHO_PIN ,INPUT_FLOATING);
				MDIO_voidSetDirection(ULTRA7_PORT_NO ,ULTRA8_ECHO_PIN ,INPUT_FLOATING);
...
void HUltrasonic_uint32GetDisX4(uint8 Copy_uint8TIMERNO,uint32 *Copy_uint32DisArray){
	...
	switch(Copy_uint8TIMERNO){
	case ULTRA_1_X4_TIMER_NO_COPY:
				MDIO_voidWrite_D_pin(PORTA ,ULTRA_1_X4_TRIG_PIN ,LOW);
				MSYSTICK_voidDelay_uS(5);
				MDIO_voidWrite_D_pin(PORTA ,ULTRA_1_X4_TRIG_PIN ,HIGH);
				MSYSTICK_voidDelay_uS(10);
				MDIO_voidWrite_D_pin(PORTA,ULTRA_1_X4_TRIG_PIN ,LOW);
	...
	case ULTRA_2_X4_TIMER_NO_COPY:
		...
		MDIO_voidWrite_D_pin(PORTA ,ULTRA_2_X4_TRIG_PIN ,LOW);
		MSYSTICK_voidDelay_uS(5);
		MDIO_voidWrite_D_pin(PORTA ,ULTRA_2_X4_TRIG_PIN ,HIGH);
		MSYSTICK_voidDelay_uS(10);
		MDIO_voidWrite_D_pin(PORTA,ULTRA_2_X4_TRIG_PIN ,LOW);
